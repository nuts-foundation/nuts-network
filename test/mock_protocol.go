...
func (m *MockProtocol) Start(p2pNetwork p2p.P2PNetwork, source proto.HashSource) {
	m.ctrl.T.Helper()
...
func (m *MockProtocol) ReceivedConsistencyHashes() proto.PeerHashQueue {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ReceivedConsistencyHashes")
	ret0, _ := ret[0].(proto.PeerHashQueue)
	return ret0
}
...
func (m *MockProtocol) ReceivedDocumentHashes() proto.PeerHashQueue {
	m.ctrl.T.Helper()
...
func (m *MockPeerHashQueue) Get(cxt context.Context) (proto.PeerHash, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", cxt)
	ret0, _ := ret[0].(proto.PeerHash)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
