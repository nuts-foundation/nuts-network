...
htmlhelp_basename = 'NutsNetworkdoc'
...
latex_documents = [
    (master_doc, 'NutsNetwork.tex', u'Nuts Network Documentation',
...
man_pages = [
    (master_doc, 'nutsnetwork', u'Nuts Network Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NutsNetwork', u'Nuts Network Documentation',
     author, 'NutsNetwork', 'One line description of project.',
     'Miscellaneous'),
]
